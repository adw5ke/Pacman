...
public class GhostEyes : MonoBehaviour {
    ...
    private void Awake() {
        ...
        this.movement = GetComponentInParent<Movement>(); // eyes is a child of movement
    }

    // set the eye sprite on the sprite renderer based on the direction of the ghost
    private void Update() {
